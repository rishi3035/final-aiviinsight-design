...
export function BVISection({ onOpenDemo }: BVISectionProps) {
  ...
  return (
    <section
      id="bvi"
      className="relative w-full bg-[#05070B] text-white py-14 sm:py-20 lg:py-24 px-4 sm:px-8 lg:px-12 overflow-hidden border-t border-white/10 scroll-mt-16 select-text flex flex-col justify-center"
    >
      {/* Background subtle radial ambient lighting */}
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-[#C8102E]/10 rounded-full blur-[120px] pointer-events-none -z-0" />
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[300px] bg-purple-600/5 rounded-full blur-[140px] pointer-events-none -z-0" />

      <div className="max-w-[1280px] mx-auto w-full relative z-10 space-y-8 sm:space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-end justify-between">
          <div className="lg:col-span-7 space-y-3 text-left">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1C1427] border border-[#3E2368] text-xs font-sans text-[#B388FF] shadow-xs"
            >
              <Sparkles className="size-3 text-[#C8102E]" />
              <span className="font-semibold text-[11px] tracking-wide">Bharat Visibility Index™</span>
            </motion.div>
            ...
            <motion.h2
              ...
              className="font-jakarta text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-[1.12]"
            >
              Core-powered by <br />
              <span className="bg-gradient-to-r from-white via-neutral-100 to-neutral-400 bg-clip-text text-transparent">
                Bharat AI Engine
              </span>
              <span className="text-xs sm:text-sm font-normal text-neutral-400 font-sans ml-2.5 inline-block align-middle">
          ...
          <div className="lg:col-span-5 text-left lg:text-right">
            <motion.p
              ...
              className="font-sans text-xs sm:text-sm md:text-base text-neutral-400 leading-relaxed max-w-md lg:ml-auto"
            >
        ...
        {/* ── 5-Card Bento Grid Layout (Exact Structure from Reference UI) ── */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-5 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-7 rounded-2xl bg-[#0F131C] border border-white/10 hover:border-white/20 p-5 sm:p-6 flex flex-col justify-between space-y-6 relative overflow-hidden transition-all shadow-xl"
          >
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center">
              ...
              <div className="sm:col-span-6 space-y-4 text-left">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="size-7 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-neutral-400 hover:text-white transition-colors cursor-pointer"
                  >
              ...
              <div className="sm:col-span-6 rounded-xl bg-[#080B11] border border-white/5 p-4 space-y-2 text-left">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-sans text-neutral-400">System scan</span>
                  <div className="flex items-center gap-1 text-[11px] font-sans text-neutral-300 bg-white/5 px-2 py-0.5 rounded border border-white/10">
                    <span>Weekly</span>
                ...
                <div className="space-y-0.5">
                  <div className="text-2xl sm:text-3xl font-extrabold font-jakarta text-white">
                    94.8 <span className="text-xs font-normal text-neutral-400">/100</span>
                  </div>
                ...
                <div className="relative pt-2 h-16 w-full">
                  <svg className="w-full h-full overflow-visible" viewBox="0 0 200 60" fill="none">
                    ...
                    <circle cx="145" cy="9" r="4.5" fill="#C8102E" className="animate-pulse" />
                    <circle cx="145" cy="9" r="2" fill="#FFFFFF" />
                  </svg>
                </div>
                ...
                <div className="flex justify-between text-[9px] font-mono text-neutral-500 pt-1">
                  ...
                  <span>tue</span>
                  <span>wed</span>
                  <span className="text-white font-bold bg-[#C8102E] px-1 rounded-xs">thu</span>
                  <span>fri</span>
                  <span>sat</span>
                </div>
              </div>
          ...
          {/* ════ CARD 2: Artificial General Intelligence / Indic Models (Span 5 cols) ════ */}
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.4, delay: 0.08 }}
            className="lg:col-span-5 rounded-2xl bg-[#0F131C] border border-white/10 hover:border-white/20 p-5 sm:p-6 flex flex-col justify-between space-y-4 text-left transition-all shadow-xl"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-[#B388FF] font-sans text-xs font-bold">
            ...
            <div className="space-y-2">
              <h3 className="font-jakarta text-base sm:text-lg font-bold text-white tracking-tight">
            ...
            <div className="p-2.5 rounded-xl bg-[#080B11] border border-white/5 flex items-center justify-between text-[11px] font-mono text-neutral-300">
          ...
          <motion.div
            ...
            className="md:col-span-1 lg:col-span-3 rounded-2xl bg-[#0F131C] border border-white/10 hover:border-white/20 p-5 flex flex-col justify-between space-y-3 text-left transition-all shadow-xl"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-white font-sans text-xs font-bold">
                <Shield className="size-3.5 text-[#C8102E]" />
          ...
          >
            ...
            <div className="text-[11px] font-mono text-blue-400 font-semibold pt-1">
                ...
                {Array.from({ length: 24 }).map((_, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={cn(
                        "h-2.5 rounded-xs transition-all",
                        isBright
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-rose-400 font-sans text-xs font-bold">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-end gap-1 pt-1 h-5">
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isAlert
                          ? "bg-[#C8102E] shadow-xs shadow-red-950/40"
                          : "bg-neutral-700/50"
                      )}
                    />
                  );
