...
export function FlipCard({
  ...
  return (
    <div
      ...
      className={cn(
        "relative h-[385px] sm:h-[395px] lg:h-[405px] w-full cursor-pointer outline-none transition-transform duration-500 ease-in-out [perspective:1200px] select-none",
