...
export interface BentoGridShowcaseProps {
  /** Slot for the tall card (e.g., Integration / AI Citation Architecture) */
  integration: React.ReactNode;
  /** Slot for the top-middle card (e.g., Trackers / Live LLM Trackers) */
  trackers: React.ReactNode;
  /** Slot for the top-right card (e.g., Statistic / 10X Authority Metric) */
  statistic: React.ReactNode;
  /** Slot for the middle-middle card (e.g., Focus / Grounding Ratio) */
  focus: React.ReactNode;
  /** Slot for the middle-right card (e.g., Productivity / Sovereign Protection) */
  productivity: React.ReactNode;
  /** Slot for the wide bottom card (e.g., Shortcuts / 1-Click Cursor IDE Remediations) */
