  ...
  return (
    <div className="min-h-screen flex flex-col w-full bg-[#FAF9F6] text-[#171717] selection:bg-[#C8102E] selection:text-white">
      ...
      <main className="flex-1 flex flex-col w-full">
        ...
        {/* SECTION 2: STATUTORY & ECOSYSTEM TRUST STRIP */}
        <TrustStrip />

        {/* SECTION 3: BHARAT VISIBILITY INDEX (FLAGSHIP PRODUCT INNOVATION) */}
        <BVISection onOpenDemo={handleOpenDemo} />

        {/* SECTION 3.5: CLIENT TESTIMONIALS (3-COLUMN INFINITE SCROLL) - INACTIVE */}
        {/* <TestimonialsSection onOpenDemo={() => handleOpenDemo()} /> */}

        {/* SECTION 4: PRICING SECTION */}
        <PricingSection onOpenDemo={() => handleOpenDemo()} />

        {/* SECTION 4.5: THE AI ANSWER ROOM (COMPACT PRODUCT SHOWCASE) */}
        <AIAnswerRoomSection onOpenDemo={handleOpenDemo} />

        {/* SECTION 5: FREQUENTLY ASKED QUESTIONS (SCROLL ACCORDION - WHITE THEME) */}
